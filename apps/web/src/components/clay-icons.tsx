...
const ClayFilter = () => (
  <defs>
    <filter id="clayShadow" x="-20%" y="-20%" width="140%" height="140%">
      <feDropShadow dx="1.5" dy="1.5" stdDeviation="1.5" floodColor="#d1d5db" floodOpacity="0.6" />
    </filter>
    <linearGradient id="greenGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stopColor="#00C700" />
      <stop offset="100%" stopColor="#6CE71D" />
    </linearGradient>
    <linearGradient id="limeGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stopColor="#6CE71D" />
...
export function ClayWalletIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      {/* Body */}
      <rect x="4" y="12" width="34" height="26" rx="6" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      {/* Flap */}
      <path d="M4 18C4 14.6863 6.68629 12 10 12H32C35.3137 12 38 14.6863 38 18V18H4V18Z" fill="#00a800" opacity="0.5" />
      {/* Card slot */}
      <rect x="26" y="22" width="16" height="10" rx="5" fill="url(#whiteGrad)" filter="url(#clayShadow)" />
      {/* Coin */}
      <circle cx="34" cy="27" r="3" fill="url(#limeGrad)" />
      {/* Shine */}
...
export function ClayGroupIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      {/* Person 1 (center) */}
      <circle cx="24" cy="16" r="7" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      <ellipse cx="24" cy="37" rx="11" ry="7" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      {/* Person 2 (left) */}
      <circle cx="12" cy="20" r="5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <ellipse cx="12" cy="37" rx="8" ry="5.5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      {/* Person 3 (right) */}
      <circle cx="36" cy="20" r="5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <ellipse cx="36" cy="37" rx="8" ry="5.5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      {/* Shine */}
...
export function ClayReceiptIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      ...
      {/* Lines */}
      <rect x="15" y="12" width="18" height="3" rx="1.5" fill="url(#greenGrad)" opacity="0.7" />
      ...
      {/* Checkmark */}
      <circle cx="35" cy="31" r="4" fill="url(#greenGrad)" filter="url(#clayShadow)" />
...
export function ClayChartIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      ...
      {/* Bars */}
      <rect x="8" y="24" width="7" height="14" rx="3.5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <rect x="20" y="14" width="7" height="24" rx="3.5" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      <rect x="32" y="8" width="7" height="30" rx="3.5" fill="url(#greenGrad)" filter="url(#clayShadow)" />
...
export function ClayPlusIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      <circle cx="24" cy="24" r="18" fill="url(#greenGrad)" filter="url(#clayShadow)" />
...
export function ClayLinkIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      {/* Left link */}
      <rect x="6" y="16" width="20" height="16" rx="8" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      <rect x="10" y="20" width="12" height="8" rx="4" fill="url(#whiteGrad)" />
      {/* Right link */}
      <rect x="22" y="16" width="20" height="16" rx="8" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <rect x="26" y="20" width="12" height="8" rx="4" fill="url(#whiteGrad)" />
      {/* Overlap connector */}
      <rect x="22" y="18" width="6" height="12" rx="3" fill="url(#greenGrad)" opacity="0.7" />
    </svg>
  );
}
...
export function ClayShieldIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      <path d="M24 4L6 12V24C6 35 14 42 24 44C34 42 42 35 42 24V12L24 4Z" fill="url(#greenGrad)" filter="url(#clayShadow)" />
...
export function ClayMoneyIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      ...
      <ellipse cx="24" cy="30" rx="14" ry="4.5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <ellipse cx="24" cy="24" rx="14" ry="4.5" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      <ellipse cx="24" cy="18" rx="12" ry="4" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      {/* Rupee symbol */}
...
export function ClayBellIcon({ size = 48, className, ...props }: ClayIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} {...props}>
      <ClayFilter />
      <path d="M24 4C24 4 16 4 14 14C12 24 8 28 8 28H40C40 28 36 24 34 14C32 4 24 4 24 4Z" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      <rect x="8" y="28" width="32" height="5" rx="2.5" fill="url(#limeGrad)" filter="url(#clayShadow)" />
      <ellipse cx="24" cy="38" rx="4" ry="3" fill="url(#greenGrad)" filter="url(#clayShadow)" />
      {/* Shine */}
