...
import { GroupInfoSidebar } from "@/shared/components/layout/GroupInfoSidebar";
import { useGroups, useCreateGroup, useJoinGroup, useGroup } from "@/features/groups/hooks/useGroups";
import {
  Dialog,
  DialogContent,
  DialogDescription,
